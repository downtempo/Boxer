...
|--------|-----------|-------|
| `chore/cleanup-and-deps` | A1, A3, A4, A6, A7, A15, A24 + the Tier 0+1 hotkey-prompt opt-in change (see [BXKeyboardEventTap.m:107](Boxer/BXKeyboardEventTap.m:107)) | Cleanup, deprecated-API replacements, dep refresh, concurrency hot-paths, defense-in-depth, permission-prompt UX. All small, all upstream-friendly individually. |
